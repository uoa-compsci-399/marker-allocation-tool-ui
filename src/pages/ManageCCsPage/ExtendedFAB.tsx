...
const ExtendedFAB = ({ title, to }: ExtendedFABProps): JSX.Element => {
  return (
    <div className="flex m-auto justify-end mr-10">
      <Link
        to={to}
        className="text-white px-4 py-2 w-auto h-12 bg-indigo-600 rounded-full hover:bg-indigo-800 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none"
      >
        <svg
          viewBox="0 0 20 20"
