...
const CourseDetail = (props: RouteComponentProps): JSX.Element => {
  ...
  const [count] = useFetchAvailableCount(`${api_url}/api/course/${courseFilter}/application/open`);
  ...
  return (
    <div>
            ...
            <div className="m-auto">
              <div className="text-xl font-semibold tracking-wide">
                ...
                <a href="/" className="font-normal">
                  {course.data.courseCoordinators}
                </a>
              </div>
      ...
      <div className="my-6 text-2xl font-semibold">
        ...
        <Table courseID={courseFilter} statusFilter={statusFilter} sortFilter={sortFilter} />
      </div>
    </div>
  );
};
